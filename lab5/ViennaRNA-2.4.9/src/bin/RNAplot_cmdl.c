...
init_full_help_array(void)
{
  ...
  RNAplot_args_info_full_help[13] = RNAplot_args_info_detailed_help[17];
  RNAplot_args_info_full_help[14] = RNAplot_args_info_detailed_help[18];
  RNAplot_args_info_full_help[15] = RNAplot_args_info_detailed_help[19];
  RNAplot_args_info_full_help[16] = RNAplot_args_info_detailed_help[21];
  RNAplot_args_info_full_help[17] = RNAplot_args_info_detailed_help[23];
  RNAplot_args_info_full_help[18] = RNAplot_args_info_detailed_help[25];
  RNAplot_args_info_full_help[19] = RNAplot_args_info_detailed_help[27];
  RNAplot_args_info_full_help[20] = RNAplot_args_info_detailed_help[29];
  RNAplot_args_info_full_help[21] = RNAplot_args_info_detailed_help[31];
  RNAplot_args_info_full_help[22] = RNAplot_args_info_detailed_help[33];
  RNAplot_args_info_full_help[23] = 0; 
  
}

const char *RNAplot_args_info_full_help[24];
...
init_help_array(void)
{
  ...
  RNAplot_args_info_help[12] = RNAplot_args_info_detailed_help[17];
  RNAplot_args_info_help[13] = RNAplot_args_info_detailed_help[18];
  RNAplot_args_info_help[14] = RNAplot_args_info_detailed_help[19];
  RNAplot_args_info_help[15] = RNAplot_args_info_detailed_help[21];
  RNAplot_args_info_help[16] = RNAplot_args_info_detailed_help[33];
  RNAplot_args_info_help[17] = 0; 
  
}

const char *RNAplot_args_info_help[18];
...
void init_args_info(struct RNAplot_args_info *args_info)
{
  ...
  args_info->pre_help = RNAplot_args_info_detailed_help[17] ;
  args_info->post_help = RNAplot_args_info_detailed_help[18] ;
  args_info->auto_id_help = RNAplot_args_info_detailed_help[19] ;
  args_info->id_prefix_help = RNAplot_args_info_detailed_help[21] ;
  args_info->id_delim_help = RNAplot_args_info_detailed_help[23] ;
  args_info->id_digits_help = RNAplot_args_info_detailed_help[25] ;
  args_info->id_start_help = RNAplot_args_info_detailed_help[27] ;
  args_info->filename_delim_help = RNAplot_args_info_detailed_help[29] ;
  args_info->filename_full_help = RNAplot_args_info_detailed_help[31] ;
