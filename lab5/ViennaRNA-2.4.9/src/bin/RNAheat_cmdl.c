/*
  ...
  /usr/bin/gengetopt -i RNAheat.ggo --file-name=RNAheat_cmdl --include-getopt --default-optional --func-name=RNAheat_cmdline_parser --arg-struct-name=RNAheat_args_info
...
init_full_help_array(void)
{
  ...
  RNAheat_args_info_full_help[26] = RNAheat_args_info_detailed_help[35];
  RNAheat_args_info_full_help[27] = 0; 
  
}

const char *RNAheat_args_info_full_help[28];
...
init_help_array(void)
{
  ...
  RNAheat_args_info_help[21] = RNAheat_args_info_detailed_help[35];
  RNAheat_args_info_help[22] = 0; 
  
}

const char *RNAheat_args_info_help[23];
...
void init_args_info(struct RNAheat_args_info *args_info)
{
  ...
  args_info->gquad_help = RNAheat_args_info_detailed_help[34] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVm:4d:P:e:g", long_options, &option_index);
