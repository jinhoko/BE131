...
init_help_array(void)
{
  ...
  RNAfold_args_info_help[13] = RNAfold_args_info_detailed_help[20];
  RNAfold_args_info_help[14] = RNAfold_args_info_detailed_help[32];
  RNAfold_args_info_help[15] = RNAfold_args_info_detailed_help[33];
  RNAfold_args_info_help[16] = RNAfold_args_info_detailed_help[34];
  RNAfold_args_info_help[17] = RNAfold_args_info_detailed_help[35];
  RNAfold_args_info_help[18] = RNAfold_args_info_detailed_help[37];
  RNAfold_args_info_help[19] = RNAfold_args_info_detailed_help[39];
  RNAfold_args_info_help[20] = RNAfold_args_info_detailed_help[40];
  RNAfold_args_info_help[21] = RNAfold_args_info_detailed_help[41];
  RNAfold_args_info_help[22] = RNAfold_args_info_detailed_help[42];
  RNAfold_args_info_help[23] = RNAfold_args_info_detailed_help[44];
  RNAfold_args_info_help[24] = RNAfold_args_info_detailed_help[50];
  RNAfold_args_info_help[25] = RNAfold_args_info_detailed_help[51];
  RNAfold_args_info_help[26] = RNAfold_args_info_detailed_help[52];
  RNAfold_args_info_help[27] = RNAfold_args_info_detailed_help[54];
  RNAfold_args_info_help[28] = RNAfold_args_info_detailed_help[58];
  RNAfold_args_info_help[29] = RNAfold_args_info_detailed_help[63];
  RNAfold_args_info_help[30] = RNAfold_args_info_detailed_help[64];
  RNAfold_args_info_help[31] = RNAfold_args_info_detailed_help[65];
  RNAfold_args_info_help[32] = RNAfold_args_info_detailed_help[66];
  RNAfold_args_info_help[33] = RNAfold_args_info_detailed_help[68];
  RNAfold_args_info_help[34] = RNAfold_args_info_detailed_help[70];
  RNAfold_args_info_help[35] = RNAfold_args_info_detailed_help[72];
  RNAfold_args_info_help[36] = RNAfold_args_info_detailed_help[73];
  RNAfold_args_info_help[37] = RNAfold_args_info_detailed_help[74];
  RNAfold_args_info_help[38] = RNAfold_args_info_detailed_help[81];
  RNAfold_args_info_help[39] = 0; 
  
}

const char *RNAfold_args_info_help[40];
