...
init_full_help_array(void)
{
  ...
  RNAalifold_args_info_full_help[31] = RNAalifold_args_info_detailed_help[46];
  ...
  RNAalifold_args_info_full_help[39] = RNAalifold_args_info_detailed_help[59];
  RNAalifold_args_info_full_help[40] = RNAalifold_args_info_detailed_help[60];
  ...
  RNAalifold_args_info_full_help[47] = RNAalifold_args_info_detailed_help[69];
  RNAalifold_args_info_full_help[48] = RNAalifold_args_info_detailed_help[70];
  RNAalifold_args_info_full_help[49] = RNAalifold_args_info_detailed_help[72];
  RNAalifold_args_info_full_help[50] = RNAalifold_args_info_detailed_help[74];
  RNAalifold_args_info_full_help[51] = RNAalifold_args_info_detailed_help[76];
  ...
  RNAalifold_args_info_full_help[64] = 0; 
  
}

const char *RNAalifold_args_info_full_help[65];
...
init_help_array(void)
{
  ...
  RNAalifold_args_info_help[18] = RNAalifold_args_info_detailed_help[38];
  RNAalifold_args_info_help[19] = RNAalifold_args_info_detailed_help[39];
  RNAalifold_args_info_help[20] = RNAalifold_args_info_detailed_help[40];
  RNAalifold_args_info_help[21] = RNAalifold_args_info_detailed_help[41];
  ...
  RNAalifold_args_info_help[24] = RNAalifold_args_info_detailed_help[46];
  ...
  RNAalifold_args_info_help[28] = RNAalifold_args_info_detailed_help[53];
  RNAalifold_args_info_help[29] = RNAalifold_args_info_detailed_help[54];
  ...
  RNAalifold_args_info_help[32] = RNAalifold_args_info_detailed_help[59];
  RNAalifold_args_info_help[33] = RNAalifold_args_info_detailed_help[60];
  RNAalifold_args_info_help[34] = RNAalifold_args_info_detailed_help[63];
  RNAalifold_args_info_help[35] = RNAalifold_args_info_detailed_help[66];
  RNAalifold_args_info_help[36] = RNAalifold_args_info_detailed_help[67];
  RNAalifold_args_info_help[37] = RNAalifold_args_info_detailed_help[68];
  RNAalifold_args_info_help[38] = RNAalifold_args_info_detailed_help[69];
  RNAalifold_args_info_help[39] = RNAalifold_args_info_detailed_help[70];
  RNAalifold_args_info_help[40] = RNAalifold_args_info_detailed_help[72];
  RNAalifold_args_info_help[41] = RNAalifold_args_info_detailed_help[74];
  RNAalifold_args_info_help[42] = RNAalifold_args_info_detailed_help[76];
  RNAalifold_args_info_help[43] = RNAalifold_args_info_detailed_help[77];
  RNAalifold_args_info_help[44] = RNAalifold_args_info_detailed_help[78];
  RNAalifold_args_info_help[45] = RNAalifold_args_info_detailed_help[79];
  RNAalifold_args_info_help[46] = RNAalifold_args_info_detailed_help[80];
  RNAalifold_args_info_help[47] = RNAalifold_args_info_detailed_help[81];
  RNAalifold_args_info_help[48] = RNAalifold_args_info_detailed_help[82];
  RNAalifold_args_info_help[49] = RNAalifold_args_info_detailed_help[83];
  RNAalifold_args_info_help[50] = RNAalifold_args_info_detailed_help[84];
  RNAalifold_args_info_help[51] = RNAalifold_args_info_detailed_help[91];
  RNAalifold_args_info_help[52] = 0; 
  
}

const char *RNAalifold_args_info_help[53];
...
void init_args_info(struct RNAalifold_args_info *args_info)
{
  ...
  args_info->input_format_help = RNAalifold_args_info_detailed_help[22] ;
  args_info->continuous_ids_help = RNAalifold_args_info_detailed_help[24] ;
  args_info->auto_id_help = RNAalifold_args_info_detailed_help[26] ;
  args_info->id_prefix_help = RNAalifold_args_info_detailed_help[28] ;
  args_info->id_delim_help = RNAalifold_args_info_detailed_help[30] ;
  args_info->id_digits_help = RNAalifold_args_info_detailed_help[32] ;
  args_info->id_start_help = RNAalifold_args_info_detailed_help[34] ;
  args_info->filename_delim_help = RNAalifold_args_info_detailed_help[36] ;
  args_info->maxBPspan_help = RNAalifold_args_info_detailed_help[40] ;
  args_info->constraint_help = RNAalifold_args_info_detailed_help[41] ;
  args_info->batch_help = RNAalifold_args_info_detailed_help[43] ;
  args_info->enforceConstraint_help = RNAalifold_args_info_detailed_help[45] ;
  args_info->SS_cons_help = RNAalifold_args_info_detailed_help[46] ;
  args_info->shape_help = RNAalifold_args_info_detailed_help[48] ;
  args_info->shape_min = 1;
  args_info->shape_max = 0;
  args_info->shapeMethod_help = RNAalifold_args_info_detailed_help[50] ;
  args_info->partfunc_help = RNAalifold_args_info_detailed_help[54] ;
  args_info->MEA_help = RNAalifold_args_info_detailed_help[56] ;
  args_info->mis_help = RNAalifold_args_info_detailed_help[58] ;
  args_info->stochBT_help = RNAalifold_args_info_detailed_help[59] ;
  args_info->stochBT_en_help = RNAalifold_args_info_detailed_help[60] ;
  args_info->pfScale_help = RNAalifold_args_info_detailed_help[61] ;
  args_info->circ_help = RNAalifold_args_info_detailed_help[63] ;
  args_info->bppmThreshold_help = RNAalifold_args_info_detailed_help[64] ;
  args_info->gquad_help = RNAalifold_args_info_detailed_help[66] ;
  args_info->sci_help = RNAalifold_args_info_detailed_help[67] ;
  args_info->temp_help = RNAalifold_args_info_detailed_help[69] ;
  args_info->noTetra_help = RNAalifold_args_info_detailed_help[70] ;
  args_info->dangles_help = RNAalifold_args_info_detailed_help[72] ;
  args_info->noLP_help = RNAalifold_args_info_detailed_help[74] ;
  args_info->noGU_help = RNAalifold_args_info_detailed_help[76] ;
  args_info->noClosingGU_help = RNAalifold_args_info_detailed_help[77] ;
  args_info->cfactor_help = RNAalifold_args_info_detailed_help[78] ;
  args_info->nfactor_help = RNAalifold_args_info_detailed_help[79] ;
  args_info->endgaps_help = RNAalifold_args_info_detailed_help[80] ;
  args_info->ribosum_file_help = RNAalifold_args_info_detailed_help[81] ;
  args_info->ribosum_scoring_help = RNAalifold_args_info_detailed_help[82] ;
  args_info->old_help = RNAalifold_args_info_detailed_help[83] ;
  args_info->paramFile_help = RNAalifold_args_info_detailed_help[84] ;
  args_info->nsp_help = RNAalifold_args_info_detailed_help[86] ;
  args_info->energyModel_help = RNAalifold_args_info_detailed_help[88] ;
  args_info->betaScale_help = RNAalifold_args_info_detailed_help[89] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvqj::t:f:nC::p::s:S:cgT:4d:ER:rP:e:", long_options, &option_index);
