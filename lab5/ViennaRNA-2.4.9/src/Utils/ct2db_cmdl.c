...
const char *ct2db_args_info_help[] = {
  ...
  "  -c, --convertToRNA  Substitute all nucleotides with their RNA alphabet\n                        counter parts, i.e. convert to characters A, C, G, U or\n                        N for unknown bases.\n                          (default=off)",
...
void clear_given (struct ct2db_args_info *args_info)
{
  ...
  args_info->convertToRNA_given = 0 ;
...
void init_args_info(struct ct2db_args_info *args_info)
{
  ...
  args_info->convertToRNA_help = ct2db_args_info_help[3] ;
...
ct2db_cmdline_parser_dump(FILE *outfile, struct ct2db_args_info *args_info)
{
  ...
  if (args_info->convertToRNA_given)
    write_into_file(outfile, "convertToRNA", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVpcv", long_options, &option_index);
...
.  */
          ...
          break;
        case 'c':	/* Substitute all nucleotides with their RNA alphabet counter parts, i.e. convert to characters A, C, G, U or N for unknown bases.
.  */
        
        
          if (update_arg((void *)&(args_info->convertToRNA_flag), 0, &(args_info->convertToRNA_given),
              &(local_args_info.convertToRNA_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "convertToRNA", 'c',
              additional_error))
            goto failure;
